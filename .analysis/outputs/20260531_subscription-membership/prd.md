...
| 5 | 정기청구 확정 방식 — 동기 응답 vs webhook | 기술 리드 | FR-04 전 |
| 6 | 멱등키 포맷·재시도 키 차원 확정 (100자) | 기술 리드 | FR-04 전 |
| 7 | 빌링키 암호화 키 관리 주체·로테이션 | 보안 | FR-00 전 |
| 8 | 스케줄러 분산 락 방식 (ShedLock 등) | 기술 리드 | FR-04 전 |
| 9 | 구독 플랜 가격 통화 (단일 vs 다통화) | PO | FR-01 전 |
