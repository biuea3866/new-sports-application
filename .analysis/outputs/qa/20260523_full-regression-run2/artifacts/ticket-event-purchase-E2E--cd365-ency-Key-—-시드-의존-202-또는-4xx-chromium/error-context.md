...
- Name: ticket-event-purchase.spec.ts >> E2E-05 ticket event · seat · purchase >> E2E-05-04 POST /ticket-orders + Idempotency-Key — 시드 의존, 202 또는 4xx
- Location: specs/ticket-event-purchase.spec.ts:55:7
...
Expected value: 401
Received array: [202, 400, 404, 409, 422, 500]
```
