...
- Name: booking-create-list.spec.ts >> E2E-03 booking create · list >> E2E-03-02 GET /bookings/{id} — 임의 id 조회 (시드 없으면 404)
- Location: specs/booking-create-list.spec.ts:30:7
