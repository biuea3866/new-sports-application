...
- Name: payment-create-list.spec.ts >> E2E-04 payment create · idempotency · list >> E2E-04-01 POST /payments + Idempotency-Key — 201 또는 도메인 예외
- Location: specs/payment-create-list.spec.ts:12:7
...
Expected value: 401
Received array: [201, 400, 404, 409, 422, 500]
```
