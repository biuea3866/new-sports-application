...
- Name: auth-register-login.spec.ts >> E2E-01 auth register · login · refresh · logout >> E2E-01-03 refreshToken 으로 토큰 갱신 시 새 accessToken 이 발급된다
- Location: specs/auth-register-login.spec.ts:42:7
