...
- Name: booking-create-list.spec.ts >> E2E-03 booking create · list >> E2E-03-E03 user-A 의 booking 을 user-B 가 조회 시 403/404
- Location: specs/booking-create-list.spec.ts:146:7
