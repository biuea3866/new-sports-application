...
- Name: ticket-event-purchase.spec.ts >> E2E-05 ticket event · seat · purchase >> E2E-05-03 POST /events/1/seats/select — 200 또는 도메인 예외
- Location: specs/ticket-event-purchase.spec.ts:40:7
...
Expected value: 429
Received array: [200, 400, 404, 409, 422, 500]
```
