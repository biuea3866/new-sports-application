...
- Name: goods-cart-order.spec.ts >> E2E-06 goods search · cart · order >> E2E-06-05 POST /cart/items — 200 또는 4xx(상품 부재)
- Location: specs/goods-cart-order.spec.ts:71:7
...
Expected value: 429
Received array: [200, 400, 404, 422, 500]
```
