...
- Name: goods-cart-order.spec.ts >> E2E-06 goods search · cart · order >> E2E-06-R03 DELETE /cart/items/{id} 후 GET /cart/me 시 해당 item 사라짐
- Location: specs/goods-cart-order.spec.ts:174:7
...
Expected value: 429
Received array: [200, 204, 403, 404]
```
