...
- Name: ticket-event-purchase.spec.ts >> E2E-05 ticket event · seat · purchase >> E2E-05-E04 좌석 락 TTL 경과 후 발권 시도 — TTL 대기 없이 만료 lockId 사용
- Location: specs/ticket-event-purchase.spec.ts:195:7
...
Expected value: 429
Received array: [400, 404, 409, 410, 422, 500]
```
