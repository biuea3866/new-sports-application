...
- Name: auth-register-login.spec.ts >> E2E-01 auth register · login · refresh · logout >> E2E-01-E01 이메일 형식 위반 가입 시 400
- Location: specs/auth-register-login.spec.ts:120:7
