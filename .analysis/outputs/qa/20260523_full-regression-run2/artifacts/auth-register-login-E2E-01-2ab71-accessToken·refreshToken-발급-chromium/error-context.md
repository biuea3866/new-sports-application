...
- Name: auth-register-login.spec.ts >> E2E-01 auth register · login · refresh · logout >> E2E-01-02 가입한 계정으로 로그인 시 200 + accessToken·refreshToken 발급
- Location: specs/auth-register-login.spec.ts:26:7
