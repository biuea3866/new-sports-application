...
- Name: booking-create-list.spec.ts >> E2E-03 booking create · list >> E2E-03-01 POST /bookings — 시드 슬롯이 없어 422/400 환경 검증으로 대체
- Location: specs/booking-create-list.spec.ts:13:7
