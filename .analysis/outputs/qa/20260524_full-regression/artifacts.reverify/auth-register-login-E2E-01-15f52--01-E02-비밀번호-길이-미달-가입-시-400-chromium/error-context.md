...
- Name: auth-register-login.spec.ts >> E2E-01 auth register · login · refresh · logout >> E2E-01-E02 비밀번호 길이 미달 가입 시 400
- Location: specs/auth-register-login.spec.ts:130:7
