 ...
 *
 * goods 전용 핸들러([LimitedDropTooEarlyException])는 facility-booking 모듈에 goods 도메인이 없어 제외한다
 * (facility-booking 자신의 컨트롤러 테스트는 이 예외를 던지지 않는다 — BusinessException 상위 핸들러로 폴백
 * 되는 원본과 동작 차이는 없다).
 */
