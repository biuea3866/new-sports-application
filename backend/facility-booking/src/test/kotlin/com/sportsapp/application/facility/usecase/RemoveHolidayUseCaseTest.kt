...
class RemoveHolidayUseCaseTest : BehaviorSpec({
    ...
    val useCase = RemoveHolidayUseCase(facilityScheduleOwnerDomainService)
    ...
    Given("소유 시설에 휴무일 제거 command가 주어졌을 때") {
        ...
        every { facilityScheduleOwnerDomainService.removeHoliday("f-001", 1L, date) } returns updatedFacility
