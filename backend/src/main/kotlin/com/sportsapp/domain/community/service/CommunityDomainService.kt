...
class CommunityDomainService(
    ...
    fun join(communityId: Long, userId: Long): CommunityMember {
        ...
        val member = communityMemberRepository.save(CommunityMember.join(communityId, userId, community.isPublic()))
    ...
    fun countActiveMembers(communityId: Long): Int =
        communityMemberRepository.findActiveByCommunityId(communityId).size
