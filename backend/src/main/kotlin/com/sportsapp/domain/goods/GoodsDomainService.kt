...
class GoodsDomainService(
    ...
    private val lProductCustomRepository: ProductCustomRepository,
    ...
    fun search(
        ...
        lProductCustomRepository.search(category, keyword, priceMin, priceMax, pageable)
    ...
    fun listMyProducts(ownerUserId: Long, pageable: Pageable): Page<ProductWithStock> =
        lProductCustomRepository.findByOwnerId(ownerUserId, pageable)
