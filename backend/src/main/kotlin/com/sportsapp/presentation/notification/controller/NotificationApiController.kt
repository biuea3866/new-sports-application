...
class NotificationApiController(
    ...
    fun registerPushToken(
        ...
        val result = registerPushTokenUseCase.execute(request.toCommand(principal.id))
    ...
    fun getUnreadCount(
        ...
        ResponseEntity.ok(UnreadCountResponse(getUnreadCountUseCase.execute(principal.id)))
    ...
    fun markRead(
        ...
        val command = MarkNotificationReadCommand(notificationId = id, userId = principal.id)
