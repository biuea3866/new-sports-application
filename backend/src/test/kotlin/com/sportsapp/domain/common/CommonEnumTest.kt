...
class CommonEnumTest : BehaviorSpec({
    ...
    Given("UserRoleName enum") {
        When("entries 를 확인하면") {
            Then("[U-01] USER, ADMIN, FACILITY_OWNER, EVENT_HOST, GOODS_SELLER, OPERATIONS_MANAGER 6개를 포함한다") {
