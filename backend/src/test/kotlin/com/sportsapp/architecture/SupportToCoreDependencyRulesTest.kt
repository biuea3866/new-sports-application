...
object DomainClassification {
    val core = listOf("booking", "facility", "goods", "payment", "ticketing", "user", "post", "message")
 ...
 * (booking/facility/goods/payment/ticketing/user/post/message)을 동기 의존(import)하지 않음을 강제한다.
 *
