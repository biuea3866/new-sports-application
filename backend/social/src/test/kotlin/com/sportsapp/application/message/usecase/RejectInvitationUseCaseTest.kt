...
class RejectInvitationUseCaseTest : BehaviorSpec({
    ...
    val rejectInvitationUseCase = RejectInvitationUseCase(guestInvitationDomainService, userDomainService)
    ...
    Given("초대 대상 본인이 초대를 거절하는 상황") {
        ...
        When("execute(invitationId=8, userId=2) 를 호출하면") {
            ...
            Then("GuestInvitationDomainService.reject 결과가 초대자 표시 이름과 함께 반환된다") {
